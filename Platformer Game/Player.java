...
public class Player extends Actor
{
    ...
    boolean onGround2(){
        Actor under2 = getOneObjectAtOffset(0, getImage().getHeight()/2,Ground.class);
        return under2 != null;
    }
    boolean onGround3(){
        Actor under3 = getOneObjectAtOffset(0, getImage().getHeight()/2,Ground.class);
        return under3 != null;
    }
    ...
    public void collect(){
        ...
        if(collect == 10&& TenCoinsCollected ==false){
            getWorld().addObject(new SecretDoor(), 975, 225);
